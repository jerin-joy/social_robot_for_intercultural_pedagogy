questions = [
    ...
    "I have also discovered that you like eating something called food. In my planet, we eat cristals! What kind of food do you eat in your country?",  
    ...
    "Together with the children, we played games and shared stories, and I told them about the magical adventures I've had on Zogar. We laughed and danced, creating memories that will last a lifetime. What's your favorite game to play with friends?",
